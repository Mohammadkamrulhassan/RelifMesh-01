...
const areaRoutes = require('./modules/areas/areaRoutes')
const needRoutes = require('./modules/need/needRoutes')
const pledgeRoutes = require('./modules/pledges/pledgeRoutes')
...
connectDB().then(() => {
  app.listen(env.port, () => {
    ...
    console.log()
    console.log('  ReliefMesh API is running')
    console.log('  ──────────────────────')
