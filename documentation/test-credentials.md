...
|------|-------|----------|--------|
| Upazila Officer | `upazila@relifmesh.test` | `password123` | `backend/db/seeds/seed.js:29-33` |
| UP Official | `upofficial@relifmesh.test` | `password123` | `backend/db/seeds/seed.js:35-39` |
| NGO Worker | `ngo@relifmesh.test` | `password123` | `backend/db/seeds/seed.js:42-48` |
| Citizen | `citizen@relifmesh.test` | `password123` | `backend/db/seeds/seed.js:49-56` |
...
| MongoDB URI (dev fallback) | `mongodb://localhost:27017/relifmesh` | `backend/config/environment.js:7` |
| MongoDB URI (example) | `mongodb://localhost:27017/relifmesh` | `backend/.env.example:2` |
